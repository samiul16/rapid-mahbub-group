      ...
      <div className="w-full bg-white">
        ...
        <div className="py-16 md:py-24 bg-white">
          <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
              ...
              >
                <motion.h2
                  className="text-3xl sm:text-4xl font-bold text-sky-400 leading-10"
                  variants={itemVariants}
                >
                  Why Join With Mahbub Group
                </motion.h2>
        ...
        <div className="py-16 md:py-24">
          <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-16">
            {/* Header */}
            <motion.h1
              className="text-3xl sm:text-4xl lg:text-5xl font-bold text-sky-400 mb-8 md:mb-10 leading-[48px]"
